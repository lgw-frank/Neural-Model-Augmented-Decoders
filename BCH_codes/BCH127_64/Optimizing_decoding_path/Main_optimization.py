...
if GL.get_map('create_update_teps_ranking'):                 
    ...
    ordering_list = [sorted_train_teps[:intercept_length],convention_teps_ordering,ALMLT_teps_ordering,\
    ...
    if GL.get_map('extended_input'):
        ...
        ordering_list = [sorted_train_teps[:intercept_length],ordering_list[1],ordering_list[2],\
