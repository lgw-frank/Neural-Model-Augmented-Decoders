...
def theoretical_ordered_statistics_mean(snr):
    ...
    inverse_list = []
    for i in range(1,code.check_matrix_column+1):
        y_value = i/(code.check_matrix_column+1)
...
for i in range(len(snr_list)):
  ...
  NN_test.plot_curve(delta_draw_list,label_list,snr,x_pos)
