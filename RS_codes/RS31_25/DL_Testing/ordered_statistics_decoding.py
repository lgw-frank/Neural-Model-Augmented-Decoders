...
class osd:
    ...
    def choose_decoding_strategy(self,SWA_model,input_list,inputs,labels,decoding_matrix):
        ...
        if GL.get_map('sliding_strategy'):
            correct_counter,fail_counter,windows_sum,complexity_sum = self.sliding_osd(SWA_model,order_list,decoding_matrix)
        else:            
        ...
        return correct_counter,fail_counter,windows_sum,complexity_sum
