...
class Decoder_Layer(tf.keras.layers.Layer):
    ...
    def get_evenly_shifted_integers(self,limit,num_count):
        ...
        #sequence = np.random.randint(0, limit, size=num_count)
...
def retore_saved_model():
    ...
    restore_ckpts_dir = f'../{prefix_str}.upper_{str(n_dims)}_training/ckpts/{decoder_type}/{str(n_iteration)}th/IF{str(reduction_iteration)}-{str(redundancy_factor)}/'
